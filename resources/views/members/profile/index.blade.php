...
<div class="row">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <!-- meta -->
            <div class="profile-user-box mt-5">
                <div class="row">
                    <div class="col-md-6">
                        <div class="profile-user-img">

                            <img src="{{ auth()->user()->photo }}" alt="" class="avatar-lg">
                        </div>
                        <div class="">
                ...
                <div class="card-body p-0">
                    <div class="profile-content">
                        <ul class="nav nav-underline nav-justified gap-0">
                            ...
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" data-bs-target="#user-activities"
                                    type="button" role="tab" aria-controls="home" aria-selected="true"
